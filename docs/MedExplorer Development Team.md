...
2  | Technical Architect | Steve B.|<ul><li>Architected the system using:</li><ul><li>Modern, responsive web development techniques</li><li>DevOps Concepts including Continuous Integration, Continuous Delivery/Deployment, Automated Test, Automated Software Quality, and Continuous Monitoring</li></ul><li>Developed product roadmaps</li><li>Communicated with all level of stakeholders</li></ul> |
...
4  | Writer/Content Designer/Content Strategist | Gil R., Pearl K., Brian W.  | <ul><li>Developed the content for the user centered design artifacts, such as user stories and personas</li><li>Collaborated with the team members on prototype content</li></ul>|
5  | Visual Designer | Gil R., Pearl K., Brian W.  |<ul><li>Lead the visual design of the prototype</li><li>Developed the style guide for the prototype</li><li>Developed the logos and icons for the prototype</li></ul> |
